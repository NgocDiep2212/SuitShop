<div class="footer">
                <div class="grid wide">
                    <div class="row footer-content container" style="margin: auto;">
                        ...
                        <div class="col l-2-4 m-4 c-6">
                            ...
                            <ul class="footer-list">
                                <li class="footer-item">
                                    <a href="" class="footer-item__link">Bộ Vest</a>
                                </li>
                                <li class="footer-item">
                                    <a href="" class="footer-item__link">Áo Vest</a>
                                </li>
                                <li class="footer-item">
                                    <a href="" class="footer-item__link">Quần Tây</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col l-2-4 m-4 c-6">
                ...
                <div class="footer__bottom">
                    <p class="footer__text">© 2023 - Bản quyền thuộc về NgocDiep</p>
                </div>
            </div>
	</div>
